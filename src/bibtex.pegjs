...
Citation = '@' CitationType _ '{' _ cn:CitationName _ "," _ ct:CitationAttribute* _ '}'
{
  var data = {};
...
UnicodeInnerData = ( UnicodeChar / [\_\.\(\)\/\-])+
...
Title
  = 'title'i _ '=' _ '{' _ title:$(_ UnicodeInnerData _)+ _ '}' ','? _
...
Authors
  = 'author'i _ "=" _ '{' _ a:Author+
  {
  	return ['author', a[0]];
  }

LastNameFragment = LatexStatement / [\,\.]

// Author with lastname, first
LastNameAuthor
  = nameTokenList:($(LastNameFragment+) _ )+ (( 'and' ) / '}' ','?) _ 
  {
    var nameList = [];
    var curName = '';
    var lastName = '';
...
FirstNameFragment = LatexStatement / [ .]

// Author with firstname last
FirstNameAuthor
  = $(FirstNameFragment)+ _ 'and' _
...
UnknownAttribute
  = n:AttributeName _ '=' _ '{' _ d:AttributeData '}' ','? _
  { return [n.trim(), d.trim()]; }

// Base Cases

UnicodeWord = ( UnicodeChar / [\_\,\.\(\)\-])+

LatexStatement = '\\' UnicodeWord '{' LatexStatement '}' / UnicodeWord
